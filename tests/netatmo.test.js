...
describe('Specific functions', () => {
  ...
  describe('data cleaning', () => {
    test('process measure of station', async () => {
      ...
      const output = { co2: 967, gustangle: 75, guststrength: 3, healthidx: 1, humidity: 41, noise: 42, pressure: 997.6, pressureabs: 1017.4, pressuretrend: 'up', rain: 0, sumrain1: 0, sumrain24: 0, temperature: 23.7, temptrend: 'up', windangle: 75, windstrength: 2 }
  ...
  describe('process data', () => {
    ...
    test('process Aircare', async () => {
      ...
      expect(spy2).toHaveBeenCalledWith('frame', { co2: 967, healthidx: 1, humidity: 41, id: '70:ee:50:22:a3:00', module: 'string', name: 'Bedroom', noise: 42, online: 1, pressure: 45, pressureabs: 1022.9, temperature: 23.7, type: 'NHC', wifistatus: 22 })
    })

    test('process Weather Station', async () => {
      const spy1 = jest.spyOn(client, 'processMeasure')
      const spy2 = jest.spyOn(eventEmitter, 'emit').mockImplementation(() => {})
      ...
      expect(spy2).toHaveBeenCalledWith('frame', { co2: 967, home: 'Home', humidity: 41, id: '70:ee:50:22:a3:00', name: 'Casa', noise: 42, online: 1, pressure: 997.6, pressureabs: 1017.4, pressuretrend: 'up', temperature: 23.7, temptrend: 'up', type: 'NAMain', wifistatus: 55 })
      expect(spy2).toHaveBeenCalledWith('frame', { battery: 58, co2: 967, home: 'Home', humidity: 41, id: '06:00:00:02:47:04', name: 'Indoor Module', online: 1, pressure: 997.6, pressureabs: 1017.4, rfstatus: 31, temperature: 23.7, temptrend: 'up', type: 'NAModule4' })
      expect(spy2).toHaveBeenCalledWith('frame', { battery: 58, home: 'Home', humidity: 41, id: '06:00:00:02:47:01', name: 'Outdoor Module', online: 1, rfstatus: 31, temperature: 23.7, temptrend: 'up', type: 'NAModule1' })
      expect(spy2).toHaveBeenCalledWith('frame', { rain: 0, sumrain1: 0, sumrain24: 0, id: '06:00:00:02:47:03', name: 'Rain gauge', type: 'NAModule3', home: 'Home', online: 1, rfstatus: 31, battery: 58 })
      expect(spy2).toHaveBeenCalledWith('frame', { windstrength: 2, windangle: 75, guststrength: 3, gustangle: 75, id: '06:00:00:02:47:02', name: 'Wind Module', type: 'NAModule2', home: 'Home', online: 1, rfstatus: 31, battery: 58 })
    })
